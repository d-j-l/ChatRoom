...
inititate route tests with "npm run-script test".
...
mongoose,
mongoose provides a straight-forward, schema-based solution to model application data. including built-in type casting, validation, query building.

chai, a BDD / TDD assertion library for node and the browser that can be paired with any javascript testing framework.

cha-http, HTTP integration testing with Chai assertions.

mocha, javascript test framework running on Node.js and in the browser, making asynchronous testing.
...
./models/channel.js,
setup to model files in the channels collection of mongodb.

./models/group.js,
setup to model files in the groups collection of mongodb.

./models/upload.js,
setup to model files in the uploads collection of mongodb.

./models/user.js,
setup to model files in the users collection of mongodb.

routeTest.js, 
contains route testing functions.
...
app.post("/api/upload"... parameters: filename, path... uploads file to uploads folder.
